                ...
                <form id="create-plat-form" class="p-4 md:p-5 w-full" method="post" action="post-create-plat.php" enctype="multipart/form-data">
                    <div class="grid gap-4 mb-4 grid-cols-2 w-full">
                        ...
                        <div class="flex space-x-3">
                            <input id="disponibilite" name="disponibilite" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="disponibilite" class="block text-sm font-medium text-gray-900 dark:text-white">Le repas est disponible</label>
                        </div>
                    </div>
