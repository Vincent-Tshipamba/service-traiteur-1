<div>
                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button"
                                ...
                                <span class="sr-only"></span>
                                <img class="w-8 h-8 rounded-full" src="../img/profil.jpeg" alt="user photo">
    ...
    <aside id="logo-sidebar"
        ...
        aria-label="Sidebar">
        <div style="padding-top: 70px;" class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li class="">
                    <a href="" class="font-bold hover:font-thin">
                        Dashboard
                    </a>
                </li>
