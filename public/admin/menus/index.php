                ...
                <div
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <a href=""
                                class="hover:bg-gray-100 py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-white text-black focus:outline-none focus:bg-[#ff6822] disabled:opacity-50 disabled:pointer-events-none">
                                Créer un repas
                            </a>
                        </div>
                    </div>
