...
<body>
                ...
                <div
                    ...
                    <div>
                        <div class="inline-flex gap-x-2">
                            ...
                            <a href="#" data-modal-target="new-menu-modal" data-modal-toggle="new-menu-modal"
                            ...
                            <?php foreach ($menus as $menu) : ?>
                                <tr>
                                    ...
                                    <td class="flex items-center justify-center space-x-1">
                                        ...
                                        <a href="/service-traiteur/public/admin/menus/post-remove.php?id=<?= $menu['id'] ?>" onclick="removemenu(event)" data-modal-toggle="modal-remove-menu" data-modal-target="modal-remove-menu">
    ...
    <?php include_once '../composants/modal-remove-menu.php'; ?>
    <?php include_once '../composants/create-menu.php'; ?>
    ...
    <script>
        function removemenu(event) {
            ...
            let form = document.getElementById('form-remove-menu');
